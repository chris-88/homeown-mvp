...
import { LayoutDashboard, Users, FileText, Users2, Landmark, LogOut } from 'lucide-react'

const nav = [
  { to: '/app/staff', label: 'Dashboard', icon: <LayoutDashboard className="h-4 w-4" />, exact: true },
  { to: '/app/staff/clients', label: 'Clients', icon: <Users className="h-4 w-4" /> },
  { to: '/app/staff/documents', label: 'Doc review', icon: <FileText className="h-4 w-4" /> },
  { to: '/app/staff/circle', label: 'Circle CRM', icon: <Users2 className="h-4 w-4" /> },
  { to: '/app/staff/dacs', label: 'DACs', icon: <Landmark className="h-4 w-4" /> },
]
